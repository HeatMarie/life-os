...
export default function RegisterPage() {
  ...
  if (success) {
    return (
      <Card className="border-green-500/20 bg-slate-900/80 backdrop-blur">
        <CardHeader className="text-center">
          ...
          <CardDescription className="text-slate-400">
            ...
            Click the link to activate your account and begin your adventure!
          </CardDescription>
        </CardHeader>
  ...
  return (
    <Card className="border-purple-500/20 bg-slate-900/80 backdrop-blur">
      <CardHeader className="text-center">
        <div className="flex justify-center mb-4">
        ...
        <CardTitle className="text-2xl text-purple-400">Create Your Character</CardTitle>
        <CardDescription className="text-slate-400">
          Begin your journey to productivity mastery
        </CardDescription>
      </CardHeader>
      ...
      <CardFooter className="justify-center">
        <p className="text-sm text-slate-400">
          ...
          <Link href="/login" className="text-purple-400 hover:text-purple-300 underline-offset-4 hover:underline">
            Sign in
          </Link>
        </p>
      </CardFooter>
