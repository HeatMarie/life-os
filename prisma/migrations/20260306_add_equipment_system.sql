...
-- CreateEnum
CREATE TYPE "UpgradeMaterial" AS ENUM ('UPGRADE_STONE', 'ENHANCEMENT_CRYSTAL', 'MYTHIC_ESSENCE');
...
-- CreateEnum
CREATE TYPE "ItemType" AS ENUM ('XP_SHARD', 'XP_CRYSTAL', 'STREAK_SHIELD', 'ENERGY_POTION', 'DOUBLE_XP_TOKEN', 'BOSS_BANE', 'HEALTH_POTION', 'REVIVE_TOKEN', 'UPGRADE_STONE', 'ENHANCEMENT_CRYSTAL', 'MYTHIC_ESSENCE');
...
CREATE TABLE "ai_preferences" (
    "id" TEXT NOT NULL,
    "userId" TEXT NOT NULL,
    "autoGenerateStories" BOOLEAN NOT NULL DEFAULT true,
    "smartTaskSuggestions" BOOLEAN NOT NULL DEFAULT true,
    "dailyBriefing" BOOLEAN NOT NULL DEFAULT false,
    "burnoutWarnings" BOOLEAN NOT NULL DEFAULT true,
    "writingAssistance" TEXT NOT NULL DEFAULT 'subtle',
    "narrativeTone" TEXT NOT NULL DEFAULT 'epic',
    "insightFrequency" TEXT NOT NULL DEFAULT 'balanced',
...
-- CreateIndex
CREATE INDEX "ai_cache_entries_skill_inputHash_idx" ON "ai_cache_entries"("skill", "inputHash");

-- CreateIndex
CREATE UNIQUE INDEX "ai_preferences_userId_key" ON "ai_preferences"("userId");

-- CreateIndex
CREATE INDEX "ai_usage_skill_date_idx" ON "ai_usage"("skill", "date");

-- CreateIndex
CREATE INDEX "ai_usage_userId_date_idx" ON "ai_usage"("userId", "date");

-- CreateIndex
CREATE INDEX "ai_usage_userId_skill_date_idx" ON "ai_usage"("userId", "skill", "date");
...
-- AddForeignKey
ALTER TABLE "equipment_inventory" ADD CONSTRAINT "equipment_inventory_characterId_fkey" FOREIGN KEY ("characterId") REFERENCES "characters"("id") ON DELETE CASCADE ON UPDATE CASCADE;
